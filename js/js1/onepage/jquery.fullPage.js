        ...
        */
        function performMovement(v){
            ...
            if (options.css3 && options.autoScrolling && !options.scrollBar) {
                ...
                $('.cont_me').css({
                    'margin-top': ($(window).height -($('.cont_me').outerHeight() + $('.top2').outerHeight())) / 2
                });
                /*$('.section,.fp-tableCell,.slimScrollDiv,.fp-scrollable').css({
            ...
            if ( contentHeight > scrollHeight) {
                ...
                //creating the scrolling
                    ...
                    element.find(SCROLLABLE_SEL).slimScroll({
                        ...
                        height: $(window).height(),//(scrollHeight+17) + 'px',
                        size: '10px',
                        alwaysVisible: true
                    });
                }
